...
# Some functions names had to be changed to enable import
# ------------------------------------------------------------------------------------------------
# ------------------------------------------------------------------------------------------------
# ------------------------------------------------------------------------------------------------
# ------------------------------------------------------------------------------------------------
...
def peak_correction(peaks,or_signal,rate):
    """
...
def filtering_det(signal,rate):
    ...
    filtered = filtering(signal,rate)
    peaks = peak_detection(filtered)
    n_peaks = peak_correction(peaks,signal,rate)
